    ...
    <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="col-lg-12 mb-4">
                <div class="card">
                    <div class="card-body row g-4">
                        <div class="col-md-4 pe-md-4 card-separator">
                            <div class="card-title d-flex align-items-start justify-content-between">
                                <h5 class="mb-0">Total Orders</h5>
                            </div>
                            <div class="d-flex justify-content-between">
                                <div class="mt-auto">
                                    <h2 class="mb-2">{{isset($orders_count)?$orders_count:''}}</h2>
                        ...
                        <div class="col-md-4 ps-md-4">
                            ...
                            <div class="d-flex justify-content-between">
                                <div class="mt-auto">
                                    <h2 class="mb-2">{{isset($users_count)?$users_count:''}}</h2>
                                </div>
                                <div id="activityChart"></div>
                            </div>
                        </div>
                ...
                <div class="card">
                    <div class="card-body row g-4">
                        <div class="col-md-4 pe-md-4 card-separator">
                            ...
                            <div class="d-flex justify-content-between">
                                <div class="mt-auto">
                                    <h2 class="mb-2">{{isset($products_count)?$products_count:''}}</h2>
                                </div>
                                <div id="visitorsChart"></div>
                            </div>
                        </div>
                        ...
                        <!--    <div class="d-flex justify-content-between">-->
                        <!--        <div class="mt-auto">-->
                        <!--            <h2 class="mb-2">{{isset($deleted_products_count)?$deleted_products_count:''}}</h2>-->
                        <!--        </div>-->
                        <!--        <div id="activityChart"></div>-->
                        <!--    </div>-->
                        <!--</div>-->
                        <div class="col-md-4 ps-md-4 card-separator">
                            ...
                            <div class="d-flex justify-content-between">
                                <div class="mt-auto">
                                    <h2 class="mb-2">{{isset($categories_count)?$categories_count:''}}</h2>
                                </div>
                                <div id="activityChart"></div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 pe-md-4 ">
                            ...
                            <div class="d-flex justify-content-between">
                                <div class="mt-auto">
                                    <h2 class="mb-2">{{isset($subcats_count)?$subcats_count:''}}</h2>
                                </div>
                                <div id="visitorsChart"></div>
                            </div>
                        </div>
        ...
        <!--<div class="row">-->
            ...
            <!--        <div class="card-body row g-4">-->
                        ...
                        <!--    <div class="d-flex justify-content-between">-->
                        <!--        <div class="mt-auto">-->
                        <!--            <h2 class="mb-2">{{isset($deleted_categories_count)?$deleted_categories_count:''}}</h2>-->
                        <!--        </div>-->
                        <!--        <div id="visitorsChart"></div>-->
                        <!--    </div>-->
                        <!--</div> -->
                        ...
                        <!--    <div class="card-title d-flex align-items-start justify-content-between">-->
                        <!--        <a >-->
                        <!--            <h5 class="mb-0">Deleted Sub Categories</h5>-->
                        <!--        </a>-->
                        <!--    </div>-->
                        <!--    <div class="d-flex justify-content-between">-->
                        <!--        <div class="mt-auto">-->
                        <!--            <h2 class="mb-2">{{isset($deleted_subcats_count)?$deleted_subcats_count:''}}</h2>-->
                        <!--        </div>-->
                        <!--        <div id="visitorsChart"></div>-->
                        <!--    </div>-->
                        <!--</div>        -->
                        ...
                        <table class="table text-nowrap">
                            ...
                            <tbody class="table-border-bottom-0">
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('assets/img/products/oneplus-lg.png')}}" alt="Oneplus"
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('assets/img/products/magic-mouse.png')}}" alt="Apple"
                                                height="32" width="32" class="me-2">
                                            <div class="d-flex flex-column">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('assets/img/products/imac-pro.png')}}" alt="Apple"
                                                height="32" width="32" class="me-2">
                                            <div class="d-flex flex-column">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('assets/img/products/note10.png')}}" alt="Samsung"
                                                height="32" width="32" class="me-2">
                                            <div class="d-flex flex-column">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('assets/img/products/iphone.png')}}" alt="Apple"
                                                height="32" width="32" class="me-2">
                                            <div class="d-flex flex-column">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('assets/img/products/mi-tv.png')}}" alt="Xiaomi"
                                                height="32" width="32" class="me-2">
                                            <div class="d-flex flex-column">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('assets/img/products/logitech-mx.png')}}" alt="Logitech"
                                                height="32" width="32" class="me-2">
                                            <div class="d-flex flex-column">
