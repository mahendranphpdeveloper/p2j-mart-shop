...
<style>
   span.active {
    ...
    <!-- "Buy Now" Livewire Event Dispatch Integration -->
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            // This script is a placeholder for future "Buy Now" integration
            // According to @ProductShow.php (lines 316-329), the correct method
            // to initiate the buy process is via Livewire dispatch:
            // $this->dispatch('buy-now', $checkoutData);
            // No explicit JavaScript is needed here in the Blade file unless supporting frontend custom events.
            // The server-side Livewire component should handle buy-now logic using the dispatch call shown above.
        });
    </script>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Customization validation only (submits are handled by Livewire event now)
            if (buyNowForm) {
