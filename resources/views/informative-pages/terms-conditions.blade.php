...
<div class="container mt-4">
    ...
    <div class="app-ecommerce">
        <form action="{{ route('save-terms-conditions') }}" method="POST">
            @csrf
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="title" name="title" 
                            value="{{ isset($termsConditions) ? $termsConditions->title : '' }}" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="content" name="content">
                            {{ isset($termsConditions) ? $termsConditions->content : '' }}
                        </textarea>
                    </div>
