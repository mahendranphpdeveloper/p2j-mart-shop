                                ...
                                if (data && data.toLowerCase() === 'returned') {
                                    ...
                                    return `
                                            <span 
                                                ...
                                                style="cursor:pointer; position:relative; background-color: orange !important; color: #fff !important;"
                                                onclick="Swal.fire({
                                                    title: 'Return Request',
                                                    html: `
                                                        <strong>Order ID:</strong> ${row.order_id}<br>
                                                        <strong>Reason:</strong> ${row.return_reason ? row.return_reason.replace(/['"`\\]/g, '\\$&') : '<em>No reason provided</em>'}<br>
                                                        <strong>Details:</strong> ${row.return_details ? row.return_details.replace(/['"`\\]/g, '\\$&') : '<em>No details provided</em>'}
                                                    `,
                                                    icon: 'warning',
                                            ...
                                            >
                                                <i class="bi bi-exclamation-triangle-fill" style="color:#ff8800; text-shadow:0 0 8px #ffe5b5, 0 0 2px #ffbb33; font-size:1.3em; vertical-align:middle;"></i>
                                                ${data}
                                            </span>
                                        `;
                                } else {
