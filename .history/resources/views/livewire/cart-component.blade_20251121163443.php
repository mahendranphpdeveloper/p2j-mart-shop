                                            ...
                                            @foreach($cartItems as $item)
                                                <tr wire:key="cart-{{ $item->id }}" data-cart-id="{{ $item->id }}">
                                                    <td class="product-thumbnail">
                                                        <a href="#">
                                                            @php
                                                                $productImage = $item->productUnit->productimage ?? null;
                                                            @endphp
                                                            @if($productImage && ($productImage->web_image_1 || $productImage->web_image_2))
                                                                <img src="{{ asset('uploads/products/' . ($productImage->web_image_1 ?? $productImage->web_image_2)) }}" alt="{{ $item->product_name }}">
                                                            @else
