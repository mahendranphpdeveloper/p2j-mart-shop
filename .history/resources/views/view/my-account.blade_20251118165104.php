                                        ...
                                        @forelse($orders as $order)
                                            <tr class="order-item" data-status="{{ $order->order_status }}"
                                                    ...
                                                    @if(!empty($order->items_details) && is_array($order->items_details))
                                                        <div class="order-products-wrap">
                                                            @foreach($order->items_details as $item)
                                                                <div class="order-product-thumb" title="{{ $item['product_name'] }}">
                                                                    <img src="{{ $item['image'] ?? asset('assets/images/default-product.jpg') }}"
                                                                        alt="{{ $item['product_name'] ?? 'Product' }}" class="order-img mb-1 rounded" style="max-width: 45px; max-height: 45px; border: 1px solid #efefef;">
                                                                </div>
                                                            @endforeach
                                                        </div>
                                                    @else
                                                ...
                                                <td class="actions-cell">
                                                    {{-- <a href="{{ route('product.view', ['id' => $order->product_id]) }}"
                                                        class="view-btn" title="View Product">
