...
@section('layoutContent')
    ...
    <script>
        $(document).ready(function () {
            ...
            // Modal for showing return details and approve/reject actions for return requests
            window.showReturnDetailsModal = function (reason, details, orderId, returnStatus) {
                ...
                // Buttons to approve/reject return if status is 'requested'
                let $btnDiv = $('#returnActionButtons');
                $btnDiv.empty();

                // ENUM('requested', 'cancelled', 'approved', 'returned')
                // Only allow approve/reject when status is 'requested'
                if ((returnStatus || "").toLowerCase() === 'requested') {
                    $btnDiv.append(`
