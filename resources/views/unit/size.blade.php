...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <h4 class="py-3 mb-4">
            <span class="text-muted fw-light">Unit List /</span> Size 
        </h4>
        ...
        <div class="card">
            ...
            <div class="card-datatable table-responsive">
                <table id="size_table" class="datatables-customers table border-top">
                    <thead>
                        <tr>  
                            <th>#</th>
                            <th>Size</th>                                                      
            ...
            <div  class="offcanvas offcanvas-end"  tabindex="-1"   id="edit-model"   aria-labelledby="offcanvasEndLabel" >
                <div class="offcanvas-header">
                    <h5 id="offcanvasEndLabel" class="offcanvas-title">Size</h5>
                    <button
                        type="button"
                ...
                <div class="offcanvas-body mb-auto mx-0 flex-grow-0">
                    <form class="ecommerce-customer-add pt-0" id="size-form" onsubmit="return false">
                ...
                <div class="offcanvas-header align-self-end">
                    <div>
                        <input type="hidden" id="m_size_id" name="m_size_id" value="0"> 
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            ta = $("#size_table").DataTable({
                ajax: {
                    url: '{{ route("get-size-table") }}',
                    method: 'GET',
                },
                columns: [
                    {
                    ...
                    },
                    {
                        className: "text-center",
                        'render': function (data, type, row) {
                            return ` <button type="button" data-id="${row['m_size_id']}" class=" update_data btn mx-2  btn-icon btn-outline-primary">
                              <span class="tf-icons bx bx-pencil"></span>
                            </button><button type="button"  data-id="${row['m_size_id']}" class="btn delete  btn-icon btn-outline-danger">
