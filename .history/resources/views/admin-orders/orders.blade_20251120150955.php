                                ...
                                if (status === 'requested') {
                                    ...
                                    return `
                                        <span
                                            ...
                                            <span style="vertical-align:middle;">Requested</span>
                                        </span>
                                    `;
                                } else if (status === 'cancelled') {
                                    return `<span class="badge bg-danger">${escapeHtml('Cancelled')}</span>`;
                                } else if (status === 'approved') {
                                    return `<span class="badge bg-success">${escapeHtml('Approved')}</span>`;
                                } else if (status === 'returned') {
                                    return `<span class="badge bg-primary">${escapeHtml('Returned')}</span>`;
                                } else {
