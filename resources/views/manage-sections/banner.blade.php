...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <h4 class="py-3 mb-4">
            <span class="text-muted fw-light">Manage Home /</span><span> Banner</span>
        </h4>
        @if($errors->any())
        <div>
            <ul>
        ...
        <div class="app-ecommerce">
            <form action="{{route('homesections.update',['homesection'=>1])}}" id="headerFooter" method="post"
                    ...
                    <div class="col-12 col-lg-8">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                <h5 class="card-tile mb-0"> Banner Details</h5>
                            </div>
                            <div class="card-body">
