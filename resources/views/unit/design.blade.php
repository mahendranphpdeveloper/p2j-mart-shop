...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <h4 class="py-3 mb-4">
            <span class="text-muted fw-light">Unit List /</span> Design 
        </h4>
        ...
        <div class="card">
            ...
            <div class="card-datatable table-responsive">
                <table id="design_table" class="datatables-customers table border-top">
                    <thead>
                        <tr>  
                            <th>#</th>
                            <th>Design Name</th>                                                      
            ...
            <div  class="offcanvas offcanvas-end"  tabindex="-1"   id="edit-model"   aria-labelledby="offcanvasEndLabel" >
                <div class="offcanvas-header">
                    <h5 id="offcanvasEndLabel" class="offcanvas-title">Design...</h5>
                    <button
                        type="button"
                ...
                <div class="offcanvas-body mb-auto mx-0 flex-grow-0">
                    <form class="ecommerce-customer-add pt-0" id="design-form" onsubmit="return false">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            ta = $("#design_table").DataTable({
                ajax: {
                    url: '{{ route("get-design-table") }}',
                    method: 'GET',
                },
                columns: [
                    {
                    ...
                    },
                    {
                        className: "text-center",
                        'render': function (data, type, row) {
                            return ` <button type="button" data-id="${row['m_design_id']}" class=" update_data btn mx-2  btn-icon btn-outline-primary">
                              <span class="tf-icons bx bx-pencil"></span>
                            </button><button type="button"  data-id="${row['m_design_id']}" class="btn delete  btn-icon btn-outline-danger">
                ...
                buttons: [{
                        text: '<i class="bx bx-plus me-0 me-sm-1"></i>Add',
                ...
                success: function (response) {
                   if(Id == 0){
                    ...
                    $("#button_name").text('Add');
                      ...
                      $('#design-form')[0].reset();
                    $('#m_master_id').val(Id);
                    $('#design_name').val(response["data"]["design_name"]??'');
