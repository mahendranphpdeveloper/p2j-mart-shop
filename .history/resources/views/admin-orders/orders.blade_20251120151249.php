                        ...
                        },
                        {
                            ...
                            render: function (data, type, row) {
                                ...
                                if (status && returnStatuses.includes(status.toLowerCase())) {
                                    ...
                                    let mentionStatus = `<span class="text-muted small" style="display:block;line-height:1;margin-top:2px;">(Status: ${escapeHtml(status)})</span>`;
                                    return `
                                        <span
                                    ...
                                    // Mention non-return status explicitly
                                    return `<span class="badge ${getOrderStatusBadge(status)}">${escapeHtml(status)}<span class="text-muted small" style="display:block;line-height:1;margin-top:2px;">(Status: ${escapeHtml(status)})</span></span>`;
                                }
                            }
                        },
                        {
