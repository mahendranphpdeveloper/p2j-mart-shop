...
class Orders extends Controller
{
    ...
    public function index()
    {
        ...
        $orderCounts = DB::table('user_orders')
            ...
            ->selectRaw('SUM(CASE WHEN return_status = "requested" THEN 1 ELSE 0 END) as returned_requested_count')
            ->selectRaw('SUM(CASE WHEN return_status = "approved" THEN 1 ELSE 0 END) as returned_approved_count')
            ->selectRaw('SUM(CASE WHEN return_status = "cancelled" THEN 1 ELSE 0 END) as returned_rejected_count')
            ->first();

        Log::info('Order counts for admin dashboard', [
