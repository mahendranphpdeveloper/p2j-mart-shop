...
@section('layoutContent')
                ...
                <div class="card-widget-separator-wrapper">
                    <div class="card-body card-widget-separator">
                        <div class="row gy-4 gy-sm-1">
                            ...
                            <div class="col-sm-6 col-lg-2">
                                <div class="d-flex justify-content-between align-items-start card-widget-1 border-end pb-3 pb-sm-0">
                                    <div>
                                        ...
                                        <p class="mb-0 text-truncate" title="Total Orders">Total Orders</p>
                                    </div>
                            ...
                            <!-- Pending Orders -->
                            <div class="col-sm-6 col-lg-2 customInput" data-type="pending">
                                <div class="d-flex justify-content-between align-items-start card-widget-2 border-end pb-3 pb-sm-0">
                                    <div>
                                        <h3 class="mb-2 position-relative" id="pending-count">
                                            {{ $orders_pending ?? '' }}
                                            @if(!empty($orders_pending) && $orders_pending > 0)
                                                <span class="notification-dot"></span>
                                            @endif
                                        </h3>
                                        <p class="mb-0 text-truncate" title="Pending">Pending</p>
                                    </div>
                            ...
                            <!-- Shipped Orders -->
                            <div class="col-sm-6 col-lg-2 customInput" data-type="shipped">
                                <div class="d-flex justify-content-between align-items-start border-end pb-3 pb-sm-0 card-widget-3">
                                    <div>
                                        <h3 class="mb-2" id="shipped-count">
                                            {{ $orders_shipped ?? '' }}
                                        </h3>
                                        <p class="mb-0 text-truncate" title="Shipped">Shipped</p>
                                    </div>
                                    <div class="avatar me-sm-4">
                                        <span class="avatar-initial rounded bg-label-secondary">
                            ...
                            <!-- Accepted Orders -->
                            <div class="col-sm-6 col-lg-2 customInput" data-type="accepted">
                                <div class="d-flex justify-content-between align-items-start border-end pb-3 pb-sm-0 card-widget-3">
                                    <div>
                                        <h3 class="mb-2" id="accepted-count">
                                            {{ $orders_accepted ?? '' }}
                                        </h3>
                                        <p class="mb-0 text-truncate" title="Accepted">Accepted</p>
                                    </div>
                                    <div class="avatar me-sm-4">
                                        <span class="avatar-initial rounded bg-label-secondary">
                            ...
                            <!-- Returned Orders -->
                            <div class="col-sm-6 col-lg-2 customInput" data-type="returned">
                                <div class="d-flex justify-content-between align-items-start">
                                    <div>
                                        <h3 class="mb-2" id="returned-count">
                                            {{ $orders_returned ?? '' }}
                                        </h3>
                                        <p class="mb-0 text-truncate" title="Returned">Returned</p>
                                    </div>
                                    <div class="avatar">
                                        <span class="avatar-initial rounded bg-label-secondary">
                        ...
                        <!-- Show sub-statuses for returned -->
                        <div class="row mt-2" style="font-size:0.97em;">
                            <div class="col-md-4 col-lg-2 mt-2">
                                <div class="d-flex flex-column align-items-start ps-2">
                                    <span class="fw-semibold">Returned Requested:</span>
                                    <span>{{ $orders_returned_requested ?? '' }}</span>
                                </div>
                            </div>
                            <div class="col-md-4 col-lg-2 mt-2">
                                <div class="d-flex flex-column align-items-start ps-2">
                                    <span class="fw-semibold">Returned Approved:</span>
                                    <span>{{ $orders_returned_approved ?? '' }}</span>
                                </div>
                            </div>
                            <div class="col-md-4 col-lg-2 mt-2">
                                <div class="d-flex flex-column align-items-start ps-2">
                                    <span class="fw-semibold">Returned Rejected:</span>
                                    <span>{{ $orders_returned_rejected ?? '' }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card">
                ...
                <div class="card-body mt-2">
                    <div class="row align-items-center mb-0">
                        ...
                        <div class="col-12 col-md-6 d-flex justify-content-md-end justify-content-start" id="order-status-filter">
                            <div class="d-flex gap-2 mb-3 mb-md-0 w-100 justify-content-md-end justify-content-start">
                                <button type="button" class="btn btn-sm btn-outline-secondary status-filter-btn active" data-status="">All</button>
                                <button type="button" class="btn btn-sm btn-outline-primary status-filter-btn" data-status="processing">Processing</button>
                                <button type="button" class="btn btn-sm btn-outline-info status-filter-btn" data-status="shipped">Shipped</button>
                                <button type="button" class="btn btn-sm btn-outline-success status-filter-btn" data-status="delivered">Delivered</button>
                                <button type="button" class="btn btn-sm btn-outline-danger status-filter-btn" data-status="cancelled">Cancelled</button>
                                <button type="button" class="btn btn-sm btn-outline-warning status-filter-btn" data-status="returned">Returned</button>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            window.showReturnDetailsModal = function (reason, details, orderId, returnStatus) {
                ...
                let $btnDiv = $('#returnActionButtons');
                $btnDiv.empty();

                // Show buttons based on returnStatus:
                // - If 'requested': Show both "Approve" and "Reject"
                // - If 'cancelled': Show only "Approve"
                // - If 'approved': Show only "Reject"
                // - Else: show none

                let status = (returnStatus || "").toLowerCase();

                if (status === 'requested') {
                    $btnDiv.append(`
                        <button type="button" class="btn btn-success btn-approve-return" style="min-width:115px;">
                          <i class="fas fa-check me-1"></i> Approve Return
                        </button>
                        <button type="button" class="btn btn-danger btn-reject-return ms-2" style="min-width:110px;">
                          <i class="fas fa-times me-1"></i> Reject Return
                        </button>
                    `);

                    $btnDiv.off('click', '.btn-approve-return').on('click', '.btn-approve-return', function () {
                        processReturnAction(orderId, 'approved');
                    });
                    $btnDiv.off('click', '.btn-reject-return').on('click', '.btn-reject-return', function () {
                        processReturnAction(orderId, 'cancelled');
                    });
                    ...
                    $btnDiv.append(`
                        <button type="button" class="btn btn-danger btn-reject-return" style="min-width:110px;">
                          <i class="fas fa-times me-1"></i> Reject Return
                        </button>
                    `);
                    $btnDiv.off('click', '.btn-reject-return').on('click', '.btn-reject-return', function () {
            ...
            function processReturnAction(orderId, action) {
                let actionLabel = (action === "approved") ? "approve" : "reject";
                if (!confirm(`Are you sure you want to ${actionLabel} this return request?`)) return;
                $.ajax({
                    url: "{{ route('orders.return-action') }}",
                    method: "POST",
                    data: {
                        order_id: orderId,
                        action: action,
                    ...
                    success: function (resp) {
                        if (resp.success) {
                            showToast(resp.message || `Return request ${actionLabel}d successfully.`, 'success');
                            $('#returnDetailsModal').modal('hide');
                            // Optionally: redraw datatable or update UI
                            $('.datatables-order').DataTable().ajax.reload(null, false);
                        } else {
                            showToast(resp.message || 'Server error. Try again.', 'error');
                        }
                    },
                    error: function (xhr) {
           ...
           // Function to trigger Datatable reload on status filter change
           // Function to trigger Datatable reload on status filter change (updated to ensure latest filter values)
           function triggerTableReload() {
               $('.datatables-order').each(function () {
                   // Get latest status filter value for each table type
                   let $table = $(this);
                   let orderType = $table.data('order-type');
                   // Find the active filter button
                   let $activeBtn = $table.closest('.tab-pane').find('.status-filter-btn.active');
                   let status = $activeBtn.length ? $activeBtn.data('status') : '';
                   // Update the table's data attribute for ajax to use
                   $table.data('order-status', status || '');
           ...
           $('.datatables-order').each(function () {
            console.log()
               let $table = $(this);
               let orderType = $table.data('order-type');
               // Default to blank or first status
               let $tabPane = $table.closest('.tab-pane');
               let $activeBtn = $tabPane.find('.status-filter-btn.active');
               let orderStatus = $activeBtn.length ? $activeBtn.data('status') : '';
               // Store current status for ajax call
               $table.data('order-status', orderStatus || '');
               $table.DataTable({
                   processing: true,
                   serverSide: true,
                   ajax: {
                       ...
                       data: function (d) {
                           // Always get status/type from up-to-date data-attributes
                           d.order_type = $table.data('order-type');
                           d.order_status = $table.data('order-status');
                       }
                   },
                    columns: [
                        ...
                        },
                        {
                            ...
                            render: function (data, type, row) {
                                ...
                                // Show return status badge with hover/click details if return_status is any of the relevant return-related values
                                const returnStatuses = [ 'returned']; 
                                if (status && returnStatuses.includes(status.toLowerCase())) {
                                    let reason = row.return_reason ? escapeHtml(row.return_reason) : '';
                                    let details = row.return_details ? escapeHtml(row.return_details) : '';
                                    let return_status = row.return_status ? escapeHtml(row.return_status) : '';
                                    ...
                                    switch(status.toLowerCase()) {
                                        case 'requested':
                                            ...
                                            break;
                                        case 'approved':
                                            statusDisplay = 'Return&nbsp;Approved';
                                            break;
                                        case 'cancelled':
                                            statusDisplay = 'Return&nbsp;Cancelled';
                                            break;
                                        case 'returned':
                                            statusDisplay = 'Returned';
                                            break;
                                        default:
                                            statusDisplay = 'Return&nbsp;Status';
                                    }
                                    // Mention the current status
                                    let mentionStatus = `<span class=" small" style="display:block;line-height:1;margin-top:2px;">(${escapeHtml(return_status)})</span>`;
                                    return `
                                        <span
                                            ...
                                            onclick="window.showReturnDetailsModal('${reason}','${details}','${orderId}','${return_status}')"
                                        >
                                            <i class="fas fa-comment-dots"
                                                style="color:#038ecd; font-size:1.25em; margin-right:0.32em; filter: drop-shadow(0 1px 3px #aaf6ff);"></i>
                                            <span style="vertical-align:middle;">${statusDisplay}</span>
                                            ${mentionStatus}
                                        </span>
                                    `;
                                } else {
            ...
            $('#cancelOrderForm').submit(function (e) {
                ...
                // Fetch CSRF token from the meta tag, fallback to hidden input if not found
                let csrfToken = $('meta[name="csrf-token"]').attr('content') || form.find('input[name="_token"]').val();
                ...
                $.ajax({
                    ...
                    error: function (xhr) {
                        let errorMsg = xhr.responseJSON?.message || xhr.responseJSON?.error || 'Failed to cancel order';
