                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="pr_detail">
                                ...
                                <div class="cart_extra">
                                    ...
                                    <div class="cart_btn d-flex align-items-center gap-2 flex-wrap">                                    
                                        ...
                                        <form wire:submit.prevent="buyNow" class="mb-0">
                                            <input type="hidden" name="product_name" value="{{ $product->product_name }}">
                                            <input type="hidden" name="quantity" value="{{ $quantity }}">
                                            <input type="hidden" name="custom_text" value="{{ $customText }}">
                                            <input type="file" wire:model="customImage" name="custom_image" style="display: none;">
                                            <button type="submit" class="btn btn-fill-line"   style="min-width: 120px; font-size: 1.07rem; background-color: #031b4e;">
                                                <i class="fa-solid fa-bolt"></i> Buy Now
                                            </button>
                                        </form>
                                        <a class="add_compare d-flex align-items-center" href="#" title="Compare">
                                            <i class="icon-shuffle"></i>
                                        </a>
                                        <a class="add_wishlist d-flex align-items-center" href="javascript:void(0);" wire:click="toggleWishlist" title="Add to Wishlist">
