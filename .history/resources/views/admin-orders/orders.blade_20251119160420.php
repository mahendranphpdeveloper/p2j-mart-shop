                                    ...
                                    return `
                                            <span 
                                                ...
                                                style="
                                                    cursor: pointer; 
                                                    position: relative; 
                                                    box-shadow: 0 4px 16px 0 #55e6b2cc, 0 1.5px 8px 1px #0c9f78cc;
                                                    background: linear-gradient(90deg, #e0ffe8 0%, #e1f7fa 100%);
                                                    color: #055160;
                                                style="cursor:pointer; position:relative; box-shadow: 0 0 12px 2px #36f2ab, 0 0 6px 1px #05d878;"
                                                onclick="window.showReturnDetailsModal('${row.return_reason ?? ''}','${row.return_details ?? ''}', '${row.order_id}')"
                                            >
                                                <i class="fas fa-comment-dots" style="color:blue; font-size:1.3em; vertical-align:middle;"></i>
                                                Return request
                                            </span>
                                        `;
                                } else {
