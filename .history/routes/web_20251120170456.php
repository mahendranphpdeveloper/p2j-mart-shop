...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::middleware(['auth:admin'])->group(function () {
       ...
       // Cancel an order (using DELETE, to match controller method and supported HTTP verbs)
       Route::match(['put', 'patch', 'delete'], 'orders/cancel', [Orders::class, 'cancel'])->name('orders.cancel');
