                    ...
                    <div class="item">
                        <div class="product_wrap">
                            <div class="product_img">
                                ...
                                @php
                                    // Fallback: resolve helper via app() if not autoloaded
                                    if (!function_exists('getWishlistProductUnitItems')) {
                                        if (function_exists('app')) {
                                            $wishlistItems = app('App\\Helpers\\global')::getWishlistProductUnitItems();
                                        } else {
                                            $wishlistItems = [];
                                        }
                                    } else {
                                        $wishlistItems = getWishlistProductUnitItems();
                                    }
