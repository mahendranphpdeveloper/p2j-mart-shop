                            ...
                            <div class="pr_detail">
                                ...
                                <div class="cart_extra">
                                    ...
                                    <div class="cart_btn d-flex flex-wrap align-items-center gap-2">
                                        ...
                                        <button class="btn btn-primary btn-shadow btn-md d-flex align-items-center gap-2 px-3 py-2"
                                            ...
                                            style="min-width: 120px; font-size: 1.07rem; BACKGROUND-COLOR: #031b4e;" >
                                            <i class="fa-solid fa-cart-shopping"></i>
                                            <span>Add to cart</span>
                                        </button>
                                        
                                        <form class="d-inline-block m-0" wire:submit.prevent="buyNow" style="margin-bottom: 0;">
                                            ...
                                            <input type="file" wire:model="customImage" name="custom_image"
                                                style="display: none;">
                                            <button type="submit"
                                                class="btn btn-outline-success btn-md btn-shadow d-flex align-items-center gap-2 px-3 py-2"
                                                style="min-width: 105px; font-size: 1.05rem;     BACKGROUND-COLOR:     BACKGROUND-COLOR: #031b4e;#031b4e;">
                                                <i class="fa fa-bolt"></i>
                                                <span>Buy Now</span>
                                            </button>
                                        </form>

                                        <a class="btn btn-light btn-circle btn-compare d-flex align-items-center justify-content-center p-0"
                                           title="Compare" href="#" style="width: 40px; height: 40px; border-radius:50%; font-size: 1.18rem;">
                                            <i class="icon-shuffle"></i>
                                        </a>
                                        <a class="btn btn-light btn-circle btn-wishlist d-flex align-items-center justify-content-center p-0"
                                           title="Add to Wishlist" href="javascript:void(0);" wire:click="toggleWishlist"
                                           style="width: 40px; height: 40px; border-radius:50%; font-size: 1.28rem;">
