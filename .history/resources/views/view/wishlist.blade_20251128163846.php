                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                @foreach($wishlistItems as $item)
                                                    @php
                                                        // Prefer the unit from productUnit relationship (via Wishlist), else fallback to product->productUnit
                                                        $product = $item->product;
                                                        $productUnit = $item->productUnit ?? ($product?->productUnit);

                                                        // Select the best product image: unit image, then product main image, else placeholder
                                                        ...
                                                        $imagePath = $unitProductImage
                                                            ...
                                                            : (
                                                                $mainProductImage
                                                                    ? url('uploads/products/' . $mainProductImage)
