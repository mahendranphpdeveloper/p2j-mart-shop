...
! function () {
    ...
    function c(o) {
        o && null !== o._element && (e && (e.classList.remove(a), DOMTokenList.prototype.remove.apply(e.classList, i)), t && t.classList.remove(a, n), o.dispose())
    }
    o && (o.onclick = function () {
        r && c(r), a = document.querySelector("#selectType").value, n = document.querySelector("#selectAnimation").value, t.classList.add(a, n), r = new bootstrap.Toast(t), r.show()
    }), s && (s.onclick = function () {
        l && c(l), a = document.querySelector("#selectTypeOpt").value, i = document.querySelector("#selectPlacement").value.split(" "), e.classList.add(a), DOMTokenList.prototype.add.apply(e.classList, i), l = new bootstrap.Toast(e), l.show()
    })
}(), $((function () {
    var t, e = -1,
        o = 0;
    $("#closeButton").on("click", (function () {
        ...
        var s, a, n = $("#toastTypeGroup input:radio:checked").val(),
            i = "rtl" === $("html").attr("dir"),
            r = $("#message").val(),
            l = $("#title").val() || "",
            c = $("#showDuration"),
        ...
        var y = toastr[n](r, l);
        t = y, void 0 !== y && (y.find("#okBtn").length && y.delegate("#okBtn", "click", (function () {
            alert("you clicked me. i was toast #" + f + ". goodbye!"), y.remove()
        })), y.find("#surpriseBtn").length && y.delegate("#surpriseBtn", "click", (function () {
            alert("Surprise! you clicked me. i was toast #" + f + ". You could perform an action here.")
        })), y.find(".clear").length && y.delegate(".clear", "click", (function () {
            toastr.clear(y, {
                force: !0
            })
        })))
