                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                @foreach($wishlistItems as $item)
                                                    @php
                                                        // Use product and productUnit relationships as loaded in controller
                                                        $product = $item->product;
                                                        $productUnit = $item->productUnit ?? ($product?->productUnit);

                                                        // Prefer the productUnit's image if present, else product main image, else placeholder
                                                        $unitProductImage = $productUnit?->productimage?->web_image_1 ?? null;
                                                        $mainProductImage = $product?->productImage?->web_image_1 ?? null;
                                                        $imagePath = $unitProductImage
                                                            ? asset('uploads/products/' . $unitProductImage)
                                                            : (
                                                                $mainProductImage
                                                                    ? asset('uploads/products/' . $mainProductImage)
                                                        ...
                                                        $unitPrice = $productUnit?->unit_price ?? 0;
                                                    @endphp
                                                    <tr>
