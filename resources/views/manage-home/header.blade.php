                    ...
                    <div class="col-12 col-lg-8">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <label class="form-label" for="linkedin">Email Id</label>
                                    <input type="text" class="form-control" id="email"
                                        value="{{isset($data[0]->linkedin_link) ? $data[0]->linkedin_link:''}}"
                                        placeholder="Enter linkedin link" name="linkedin_link" aria-label="linkedin">
                                </div>
