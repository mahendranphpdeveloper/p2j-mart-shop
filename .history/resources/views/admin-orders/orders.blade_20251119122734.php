...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <div class="card-header">
                <ul class="nav nav-tabs card-header-tabs" id="ordersTabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="all-orders-tab" data-bs-toggle="tab" href="#all-orders" role="tab">All Orders</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="customized-orders-tab" data-bs-toggle="tab" href="#customized-orders" role="tab">Customized Orders</a>
                    </li>
                </ul>
            </div>
        ...
        <div class="modal fade" id="orderChangeModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <form id="changeStatus">
                        ...
                        <div class="modal-body">
                            <div class="text-danger small mb-2">Warning: Please ensure that you're entering correct details.</div>
                            <div class="mb-2">
        ...
        <div class="modal fade" id="viewOrderModal" tabindex="-1" aria-labelledby="viewOrderModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="viewOrderModalLabel">Order #<span id="orderId"></span> details</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
...
$(document).ready(function () {
    ...
    $('.datatables-order').each(function() {
        ...
        $(this).DataTable({
            ...
            columns: [
                ...
                { data: 'payment_status', name: 'method', render: function(data) { return `<span class="badge ${getPaymentStatusBadge(data)}">${data}</span>`; } },
                {
                    data: 'order_status',
                    name: 'order_status',
                    render: function(data, type, row) {
                        if (data && data.toLowerCase() === 'returned') {
                            // Prepare right message icon with shadow/glow & pop modal on click
                            return `
                                <span 
                                    class="badge ${getOrderStatusBadge(data)}"
                                    style="cursor:pointer; position:relative;"
                                    onclick="showReturnDetailsModal('${escape(String(row.return_reason ?? ''))}','${escape(String(row.return_details ?? ''))}', '${row.order_id}')"
                                >
                                    <i class="bi bi-chat-dots-fill" style="color:#05d878; text-shadow:0 0 8px #36f2ab, 0 0 2px #00c97d; font-size:1.3em; vertical-align:middle;"></i>
                                    ${data}
                                </span>
                            `;
                        } else {
                            return `<span class="badge ${getOrderStatusBadge(data)}">${data}</span>`;
                        }
                    }
                },
    ...
    function showReturnDetailsModal(reason, details, orderId) {
        // Escape single quotes in parameters for security (already done in calling code)
