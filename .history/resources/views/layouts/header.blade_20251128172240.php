...
@php
    // Fetch wishlist items ONLY WHERE product_unit_id exists (not null) for logged-in user or session
    $wishlistItems = [];
    $userId = Auth::id();
    $sessionId = session()->getId();

    if ($userId || $sessionId) {
        $wishlistItems = \App\Models\Wishlist::whereNotNull('product_unit_id')
