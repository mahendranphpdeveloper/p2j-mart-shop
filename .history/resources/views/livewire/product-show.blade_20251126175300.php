                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="pr_detail">
                                ...
                                <div class="cart_extra">
                                    ...
                                    <div class="cart_btn d-flex flex-wrap align-items-center gap-1">

                                        <button class="btn btn-primary btn-shadow btn-sm d-flex align-items-center gap-1 px-2 py-1"
                                        ...
                                        <form class="d-inline-block m-0" wire:submit.prevent="buyNow" style="margin-bottom: 0;">
                                            ...
                                            <input type="file" wire:model="customImage" name="custom_image"
                                                style="display: none;">
                                            <button type="submit"
                                                class="btn btn-outline-success btn-sm btn-shadow d-flex align-items-center gap-1 px-2 py-1"
                                                style="min-width: 85px; font-size: 0.95rem;">
                                        ...
                                        <a class="btn btn-light btn-circle btn-compare d-flex align-items-center justify-content-center p-0"
                                           title="Compare" href="#" style="width: 32px; height: 32px; border-radius:50%; font-size: 1rem;">
                                            <i class="icon-shuffle"></i>
                                        </a>
                                        <a class="btn btn-light btn-circle btn-wishlist d-flex align-items-center justify-content-center p-0"
                                        <a class="add_compare" href="#"><i class="icon-shuffle"></i></a>
                                        <a class="add_wishlist" href="javascript:void(0);" wire:click="toggleWishlist">
