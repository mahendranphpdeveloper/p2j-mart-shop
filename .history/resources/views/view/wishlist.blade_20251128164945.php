                                            ...
                                            <tbody>
                                                @foreach($wishlistItems as $item)
                                                    @php
                                                        ...
                                                        $productUnit = $item->productUnit ?: ($product->productUnit ?? null);

                                                        // Use unit image if available, then product image, else placeholder
                                                        ...
                                                        $unitPrice = $productUnit->unit_price ?? null;
                                                    @endphp
                                                    <tr>
