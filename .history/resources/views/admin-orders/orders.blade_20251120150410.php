                    ...
                    columns: [
                        ...
                        },
                        {
                            ...
                            render: function (data, type, row) {
                                ...
                                // Support new status ENUM: 'requested', 'cancelled', 'approved', 'returned'
                                if (status) {
                                    ...
                                    if (statusLower === 'returned') {
                                        ...
                                        return `<span class="badge ${getOrderStatusBadge(status)}"><i class="fas fa-hourglass-start" style="color:#a27800; margin-right:0.32em;"></i>Requested</span>`;
                                    } else if (statusLower === 'cancelled') {
                                        return `<span class="badge ${getOrderStatusBadge(status)}"><i class="fas fa-times-circle" style="color:#ff3b3b; margin-right:0.32em;"></i>Cancelled</span>`;
                                    } else if (statusLower === 'approved') {
                                        return `<span class="badge ${getOrderStatusBadge(status)}"><i class="fas fa-check-circle" style="color:#28a745; margin-right:0.32em;"></i>Approved</span>`;
                                    } else {
