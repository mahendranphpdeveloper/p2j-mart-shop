                        ...
                        },
                        {
                            ...
                            render: function (data, type, row) {
                                ...
                                if (status && returnStatuses.includes(status.toLowerCase())) {
                                    ...
                                    let statusDisplay = '';
                                    switch(returnStatuses.toLowerCase()) {
                                        case 'requested':
                                    ...
                                    let mentionStatus = `<span class="text-muted small" style="display:block;line-height:1;margin-top:2px;">(${escapeHtml(statusDisplay)})</span>`;
                                    return `
                                        <span
