                ...
                <div class="card-body mt-2">
                    <div class="row align-items-center mb-0">
                        ...
                        <div class="col-12 col-md-6 d-flex justify-content-md-end justify-content-start" id="order-status-filter">
                            <div class="d-flex flex-wrap gap-2 mb-3 mb-md-0 w-100 justify-content-md-end justify-content-start">
                                ...
                                <div class="btn-group status-return-group" role="group">
                                    <button type="button" class="btn btn-sm btn-outline-warning status-filter-btn" data-status="returned">Returned</button>
                                    <button type="button" class="btn btn-sm btn-outline-dark dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false" style="min-width:30px;"></button>
                                    <ul class="dropdown-menu shadow-sm py-1">
                                        <li>
                                            <button class="dropdown-item status-filter-btn" type="button" data-status="returned_requested">Returned Requested</button>
                                        </li>
                                        <li>
                                            <button class="dropdown-item status-filter-btn" type="button" data-status="returned_approved">Returned Approved</button>
                                        </li>
                                        <li>
                                            <button class="dropdown-item status-filter-btn" type="button" data-status="returned_rejected">Returned Rejected</button>
                                        </li>
                                    </ul>
                                </div>
                            </div>
