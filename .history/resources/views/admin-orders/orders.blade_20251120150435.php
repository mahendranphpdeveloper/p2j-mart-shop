                    ...
                    columns: [
                        ...
                        },
                        {
                            ...
                            render: function (data, type, row) {
                                ...
                                // Show special badge only for return_status in ['requested', 'approved', 'cancelled', 'returned']
                                if (
                                    row.return_status &&
                                    ['requested', 'approved', 'cancelled', 'returned'].includes(row.return_status.toLowerCase())
                                ) {
                                    ...
                                    // Friendly label for return_status
                                    let statusLabel;
                                    switch (row.return_status.toLowerCase()) {
                                        case 'requested':
                                        ...
                                        case 'returned':
                                            ...
                                            break;
                                        default:
                                            statusLabel = escapeHtml(row.return_status);
                                    }
                                    ...
                                    return `
                                            ...
                                            >
                                                ...
                                                <span style="vertical-align:middle;">${statusLabel}</span>
                                            </span>
                                        `;
                                } else {
