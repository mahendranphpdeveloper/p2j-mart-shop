                ...
                <div class="card invoice-card">
                    ...
                    <div class="card-body invoice-body">
                        ...
                        <div class="mb-4 d-print-block">
                          <img src="{{ asset('uploads/logo/' . $headerFooter->image) }}" alt="Company Logo" class="invoice-logo mb-2" style="height: 65px;">
                        </div>
                        ...
                        <div class="row mb-4 invoice-info-section">
                            ...
                            <div class="col-md-6">
                                <div class="info-card">
                                    <h5 class="info-title"><i class="fas fa-credit-card me-2"></i>Payment Information</h5>
                                    <p><strong>Payment Status:</strong> 
                                        <span class="badge status-badge {{ $order->payment_status === 'completed' ? 'bg-success' : 'bg-warning' }} text-capitalize">
                                            {{ $order->payment_status }}
                                        </span>
                                    </p>
                                    <p><strong>Transaction ID:</strong> {{ $order->transaction_id }}</p>
                                    <p><strong>Total Amount:</strong> ₹{{ number_format($order->total_amount + ($order->shipping_cost ?? 0), 2) }}</p>
                                </div>
                            </div>
                        </div>
                                ...
                                <table class="table table-bordered invoice-table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>₹{{ number_format($order->total_amount / $order->quantity, ) }}</td>
...
<tr>
    ...
    <td class="grand-total">₹{{ number_format($order->total_amount + ($order->shipping_cost ?? 0), 2) }}</td>
</tr>
