                    ...
                    columns: [
                        ...
                        { data: 'payment_status', name: 'method', render: function (data) { return `<span class="badge ${getPaymentStatusBadge(data)}">${data}</span>`; } },
                        {
                            ...
                            render: function (data, type, row) {
                                // Fix: Safely show the badge, handle nulls and whitespace, and don't allow XSS injection via order_status or order_id
                                let status = (data || '').toString().trim();
                                // Basic HTML-escape function to avoid injection
                                ...
                                if (status.toLowerCase() === 'returned') {
                                    // Construct parameters safely for modal
