                        ...
                        <div class="product_wrap">
                            <div class="product_img">
                                ...
                                print_r(  $wishlistItems);
                                    ...
                                    // use $wishlistItems from header.blade.php context; fallback to []
                                    $wishUnits = isset($wishlistItems) ? $wishlistItems : [];
                                    $inWishlist = in_array($productUnitId, $wishUnits);
                                @endphp
