                                            ...
                                            <tbody>
                                                @foreach($wishlistItems as $item)
                                                    @php
                                                        ...
                                                        $productUnit = $product && $product->productUnit ? $product->productUnit : null;

                                                        $unitProductImage = $productUnit && $productUnit->productimage && $productUnit->productimage->web_image_1
                                                        ...
                                                        <td class="product-thumbnail">
                                                            <a href="{{ $productUrl }}"
                                                               ...
                                                               data-product-unit-id="{{ $productUnitId }}">
                                                                <img src="{{ $imagePath }}" alt="{{ $product ? $product->product_name : 'Product' }}">
                                                            </a>
                                                        </td>
                                                        <td class="product-name" data-title="Product">
                                                            <strong>{{ $product ? $product->product_name : 'Product' }}</strong><br />
                                                        </td>
                                                        <td class="product-price" data-title="Price">
                                                            @if($productUnit && isset($productUnit->unit_price))
                                                                ₹{{ number_format($productUnit->unit_price, 2) }}
                                                            @else
                                                                Price not available
                                                            @endif
                                                        </td>
                                                        <td class="product-add-cart" data-title="Add to Cart">
                                                          <div class="add_to_cart">
                                                            <a href="javascript:void(0);" class="add-to-cart-btn"
                                                              ...
                                                              data-quantity="1"
                                                              data-wishlist-id="{{ $item->id }}" {{-- Add extra data for removal --}}
                                                            >
