                                            ...
                                            <tr class="order-item" data-status="{{ $order->order_status }}"
                                                    ...
                                                    @if($order->order_status == 'returned')
                                                        <span class="order-status {{ $statusClass }}">
                                                            ...
                                                            @if(!empty($order->return_status))
                                                                <span style="display:inline-block;margin-left:5px;font-size:12px;color:#ff5b5c;">
                                                ...
                                                <td>
                                                    @php
                                                        ...
                                                        $statusText = $order->payment_status ?? 'Pending';
                                                        $statusClass = $paymentColors[$statusText] ?? 'badge bg-secondary';
                                                    @endphp
