                                ...
                                <tbody id="ordersTable">
                                    @forelse($orders as $order)
                                        <tr class="order-item" data-status="{{ $order->order_status }}" data-order-id="{{ $order->order_id }}">
                                            <td>
                                                @if($order->productImages && $order->productImages->web_image_1)
                                                    <img src="{{ asset('uploads/products/' . $order->productImages->web_image_1) }}" alt="{{ $order->product->name ?? 'Product' }}" class="order-img">
                                                @else
                                                    <img src="{{ asset('assets/images/default-product.jpg') }}" alt="Default Product" class="order-img">
                                                @endif
                                            </td>
                                            ...
                                            <td class="actions-cell">
                                                <a href="{{ route('product.view', ['id' => $order->product_id, 'slug' => $order->product->slug]) }}" class="view-btn" title="View Product">
