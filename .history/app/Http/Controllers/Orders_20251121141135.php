...
class Orders extends Controller
{
    ...
    public function index()
    {
        ...
        $orderCounts = DB::table('user_orders')
            ...
            ->selectRaw('SUM(CASE WHEN return_status = "returned" THEN 1 ELSE 0 END) as returned_count')
            ->selectRaw('SUM(CASE WHEN order_status = "requested" THEN 1 ELSE 0 END) as returned_requested_count')
            ->selectRaw('SUM(CASE WHEN order_status = "approved" THEN 1 ELSE 0 END) as returned_approved_count')
            ->selectRaw('SUM(CASE WHEN order_status = "rejected" THEN 1 ELSE 0 END) as returned_rejected_count')
            ->first();
